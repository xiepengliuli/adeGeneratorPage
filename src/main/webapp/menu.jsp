...
<body>
  <jsp:include page="admin/user/login.jsp"></jsp:include>
  <jsp:include page="admin/user/reg.jsp"></jsp:include>
  <div id="index_layout">
    <div
    ...
    <div
      data-options="region:'west',href:'${pageContext.request.contextPath}/admin/layout/west.jsp',split:true"
    ...
    <div data-options="region:'center'" title="欢迎使用" style="overflow: hidden;">
      <div id="index_tabs" style="overflow: hidden;">
        <div title="首页" data-options="border:false" style="overflow: hidden;">
          <iframe frameborder="0" style="border: 0; width: 100%; height: 98%;"></iframe>
        </div>
      </div>
    </div>
    <div
      data-options="region:'east',href:'${pageContext.request.contextPath}/admin/layout/east.jsp'"
