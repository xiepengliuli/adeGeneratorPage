...
import cn.com.infcn.ade.core.comparator.NameComparator;
import cn.com.infcn.ade.core.comparator.SizeComparator;
import cn.com.infcn.ade.core.comparator.TypeComparator;
import cn.com.infcn.ade.core.controller.BaseController;
import cn.com.infcn.core.util.ConfigUtil;
            ...
            try {
                ...
                for (FileItem item : items) {
                    ...
                    if (!item.isFormField()) {
                        ...
                        String newFileName = StringUtil.generateUUID() + "." + fileExt;
                        try {
